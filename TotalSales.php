...
$result = $mysqli->query("SELECT sales_tbl.Sales_ID, product_tbl.Prod_Desc, sales_tbl.Sold_Qty, (product_tbl.Prod_Qty - sales_tbl.Sold_Qty)AS Total_Item_Left, sales_tbl.Total_Sold, sales_tbl.Date FROM sales_tbl INNER JOIN product_tbl ON sales_tbl.Product_ID = product_tbl.product_id 
